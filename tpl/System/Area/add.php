<include file="Public:header"/>
	<form id="myqcorm" method="post" action="{:U('Area/modify')}" frame="true" refresh="true">
		<input type="hidden" name="area_type" value="{$_GET['type']}"/>
		<input type="hidden" name="area_pid" value="{$_GET['pid']}"/>
