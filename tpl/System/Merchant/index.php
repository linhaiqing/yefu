<include file="Public:header"/>
		<div class="mainbox">
			<div id="nav" class="mainnav_title">
				<ul>
					<a href="{:U('Merchant/index')}" class="on">商户列表</a>|
					<a href="javascript:void(0);" onclick="window.top.artiframe('{:U('Merchant/add')}','添加商户',600,400,true,false,false,addbtn,'add',true);">添加商户</a>
				</ul>
			</div>
							...
							<if condition="is_array($merchant_list)">
								<volist name="merchant_list" id="vo">
									<tr>
										...
										<!--td class="textcenter"><a href="{:U('Merchant/weidian_order',array('mer_id'=>$vo['mer_id']))}">微店账单</a></td-->
										<td class="textcenter">
