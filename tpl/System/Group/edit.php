<include file="Public:header"/>
	<form id="myqcorm" method="post" action="{:U('Merchant/amend')}" frame="true" refresh="true">
		...
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			...
			<tr>
				<th width="80">联系人</th>
				<td><input type="text" class="input fl" name="contact_name" value="{$merchant.contact_name}" size="25" placeholder="联系人的姓名" validate="maxlength:20,required:true"/></td>
			</tr>
			<tr>
				<th width="80">联系电话</th>
