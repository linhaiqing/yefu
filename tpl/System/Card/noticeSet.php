		...
		<div class="mainbox">
			<form id="myqcorm" method="post" action="" refresh="true" enctype="multipart/form-data" >
				<table cellpadding="0" cellspacing="0" class="table_form" width="100%">
					<tr>
						<td width="100">{$thisCard.cardname}：</td>
						<td>设置会员卡通知</td>
					</tr>
					<tr>
						<td width="100">标题：</td>
						<td><input type="text" class="input-text" value="{$thisNotice.title}" name="title"/></td>
					</tr>
					<tr>
						<td>有效期：</td>
						<td>
							<input type="text" class="input-text" id="endtime" value="{$thisNotice.endtime|date="Y-m-d",###}" name="endtime" onClick="WdatePicker()" style="width:90px;">
						</td>
					</tr>
					<tr>
						<td valign="top">使用说明：</td>
						<td>
							<textarea  class="col-sm-3" id="content" name="content"  style="height:125px" >{$thisNotice.content}</textarea>
						</td>
					</tr>
				</table>
				<div class="btn">
