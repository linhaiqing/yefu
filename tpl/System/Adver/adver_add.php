<include file="Public:header"/>
	<form id="myqcorm" method="post" action="{:U('Adver/adver_modify')}" enctype="multipart/form-data">
		<input type="hidden" name="cat_id" value="{$now_category.cat_id}"/>
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			<tr>
				<th width="80">广告名称</th>
				<td><input type="text" class="input fl" name="name" size="20" placeholder="请输入名称" validate="maxlength:40,required:true"/></td>
			</tr>
			<tr>
				<th width="80">广告图片</th>
