...
<p>
	...
	<div style="padding:20px 0;text-align:center;">
		...
		<!-- <input name="btnchoose" onclick="location.href='{:U('Attachment/my',array('type'=>'my'))}'" type="button" class="btnGreen" value="从素材库选择" /> -->
	</div>
</p>
...
<php>}else{</php>
	...
	<img src="/tpl/Merchant/static/images/export.png" align="absmiddle" /> 
