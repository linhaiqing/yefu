...
<style>
	...
	<form id="myqcorm" method="post" action="{:U('Deliver/user_add')}" frame="true" refresh="true">
		<input type="hidden" name="uid" value="{$now_user.uid}"/>
		<table cellpadding="0" cellspacing="0" class="frame_form" width="100%">
			<tr>
				<th width="15%">姓名</th>
				<td width="35%"><input type="text" class="input fl" name="name" size="20" validate="maxlength:50,required:true" value="{$now_user.nickname}"/></td>
				<th width="15%">手机号</th>
