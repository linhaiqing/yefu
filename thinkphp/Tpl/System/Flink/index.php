<include file="Public:header"/>
		<div class="mainbox">
			<div id="nav" class="mainnav_title">
				<ul>
					<a href="{:U('Flink/index')}" class="on">友情链接列表</a>|
					<a href="javascript:void(0);" onclick="window.top.artiframe('{:U('Flink/add')}','添加友情链接',520,250,true,false,false,addbtn,'add',true);">添加友情链接</a>
				</ul>
			</div>
