			...
			<form id="myqcorm" method="post" action="" refresh="true" enctype="multipart/form-data" >
				<table cellpadding="0" cellspacing="0" class="table_form" width="100%">
					...
					<tr>
						...
						<td><input type="text" class="input-text" name="everyday" value="{$exchange.everyday}"/>积分</td>
					</tr>
					<tr>
						<td>消费1元奖励：</td>
						<td>
							<input type="text" class="input-text" id="reward" value="{$exchange.reward}" name="reward">积分
						</td>
					</tr>
					<tr>
						<td valign="top">积分规则说明：</td>
						<td>
							<textarea  class="col-sm-3" id="cardinfo2" name="cardinfo2"  style="height:125px" >{$exchange.cardinfo2}</textarea>
						</td>
					</tr>
				</table>
				<div class="btn">
