		...
		<div class="mainbox">
			<div id="nav" class="mainnav_title">
				<ul>
					...
					<a href="{:U('Group/order_list',array('group_id'=>$now_group['group_id']))}" class="on">订单列表</a>
				</ul>
			</div>
							...
							<if condition="is_array($order_list)">
								<volist name="order_list" id="vo">
									<tr>
										...
										<td class="textcenter"><a href="javascript:void(0);" onclick="window.top.artiframe('{:U('Group/order_edit',array('order_id'=>$vo['order_id']))}','查看订单详情',660,490,true,false,false,false,'order_edit',true);">查看详情</a></td>
									</tr>
								</volist>
